...
const MENU = [
    ...
    { key: "tim-bac-si", label: "Tìm bác sĩ", Icon: IconSearch },
    { key: "chat",       label: "Chat",        Icon: IconChat, badge: true },
    { key: "ho-so",      label: "Hồ sơ",       Icon: IconUser   },
];

export default function SidebarBenhNhan({ active, setActive, chatBadge = 0 }) {
    ...
    return (
        <div style={s.wrap}>
            ...
            <div style={s.logo}>
                ...
                <span style={s.logoSub}>Bệnh nhân</span>
                {connected && <div style={s.socketDot} title="Đang kết nối realtime" />}
            </div>
            ...
            <div style={s.userCard}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={s.userSub}>Bệnh nhân</div>
                </div>
            </div>
                ...
                {MENU.map((m) => {
                    ...
                    return (
                        <button key={m.key} onClick={() => setActive(m.key)}
                            ...
                            <div style={{ ...s.iconWrap, ...(on ? s.iconOn : {}) }}>
                                <m.Icon />
                            </div>
...
function IconSearch() { return <svg width="13" height="13" viewBox="0 0 13 13" fill="none"><circle cx="5.5" cy="5.5" r="4" stroke="currentColor" strokeWidth="1"/><path d="M9 9l2.5 2.5" stroke="currentColor" strokeWidth="1" strokeLinecap="round"/></svg>; }
...
const s = {
    ...
    avatar:    { width: 30, height: 30, borderRadius: "50%", background: "#EDE9FE", color: "#6D28D9", fontSize: 12, fontWeight: 600, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 },
    ...
    iconOn:    { background: "#EDE9FE", color: "#6D28D9" },
